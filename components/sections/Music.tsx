...
export default function Music() {
  return (
    <section id="music" className="theme-inverted relative border-t border-ink-line bg-ink-raised py-24 md:py-36">
      ...
      <SectionBackground src="/assets/photography/music-01.jpg" opacity={55} />
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-ink via-ink/45 to-ink" aria-hidden />
